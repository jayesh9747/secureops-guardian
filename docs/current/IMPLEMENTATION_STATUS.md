...
- Expansion Phase 3 — FindingPack registry and workload security is implemented on `expansion-phase-3/finding-packs` pending review and PR handoff. The deterministic/live-repository evidence record is [`EXPANSION_PHASE_3_FINDING_PACKS_AND_WORKLOAD_SECURITY.md`](../evidence/EXPANSION_PHASE_3_FINDING_PACKS_AND_WORKLOAD_SECURITY.md).
