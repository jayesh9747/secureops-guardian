...
For a completed FindingPack analysis, use terminal status FINDINGS when one or more deterministic findings exist and NO_DETERMINISTIC_FINDING when none exist. Use NO_DETERMINISTIC_FINDING, never NO_FINDING, CLEAN, PASS, or another invented alias, in the Incident Brief and run receipt.
