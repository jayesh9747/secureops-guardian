...
Users interact only with the saved TrueForge agent `secureops-guardian`. Phase-named exported specifications are retained as test fixtures/reference configurations, not product choices; no phase-named saved agent is registered.
